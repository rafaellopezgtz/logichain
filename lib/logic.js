 ...
 * @param {org.oxxo.shipping.iot.ShipmentReceived} shipmentReceived - the ShipmentReceived transaction
 * @transaction
 */
function payOut(shipmentReceived) {
    ...
    return getParticipantRegistry('org.oxxo.shipping.iot.Grower')
        .then(function (growerRegistry) {
            // update the grower's balance
            return growerRegistry.update(contract.grower);
        })
        .then(function () {
            return getParticipantRegistry('org.oxxo.shipping.iot.Importer');
        })
        ...
        .then(function () {
            return getAssetRegistry('org.oxxo.shipping.iot.Shipment');
        })
 ...
 * @param {org.oxxo.shipping.iot.TemperatureReading} temperatureReading - the TemperatureReading transaction
 * @transaction
 */
function temperatureReading(temperatureReading) {

    var shipment = temperatureReading.shipment;
    var NS = 'org.oxxo.shipping.iot';
 ...
 * @param {org.oxxo.shipping.iot.GpsReading} gpsReading - the GpsReading transaction
 * @transaction
 */
 ...
 * @param {org.oxxo.shipping.iot.SetupDemo} setupDemo - the SetupDemo transaction
 * @transaction
 */
